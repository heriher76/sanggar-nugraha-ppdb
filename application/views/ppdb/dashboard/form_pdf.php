...
<table class="table table-striped table-responsive table-bordered">
	...
	<tr>
		<td colspan="3" align="center"><H4>TANDA BUKTI PENGAJUAN PENDAFTARAN CALON ANGGOTA<br/>SANGGAR NUGRAHA</H4></td>
	</TR>
	<tr>
		<td colspan="3">Print: <?php echo standard_date($format,$time);?></td>
	</tr>
	<tr class="info">
		<td colspan="3" align="center"><h4>DATA ANGGOTA</h4></td>
	</tr>
	<tr>
